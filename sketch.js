...
function setup() {
	...
	rope2=new rope(bobObject3.body,roofObject.body,-50, 0)
	rope3=new rope(bobObject2.body,roofObject.body,-60, 0)
	rope4=new rope(bobObject4.body,roofObject.body,-30, 0)
	rope5=new rope(bobObject5.body,roofObject.body,-15, 0)
